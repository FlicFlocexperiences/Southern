...
const EnvelopeIcon = () => (
  <svg className="w-4.5 h-4.5 text-white/75" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
const WhatsAppIcon = () => (
  <svg className="w-4.5 h-4.5 text-white/75" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const DesktopFooter = () => {
  ...
  return (
    <footer className="w-full bg-[#000000] text-[#a3a3a3] pt-20 pb-12 px-8 lg:px-[90px] relative z-10 overflow-hidden flex flex-col font-sans" style={{ zoom: 0.8 }}>
          ...
          <div className="lg:col-span-3 flex flex-col gap-6">
            <Link href="/" className="inline-block w-fit">
              <div className="flex items-end select-none">
                <span className="text-[44px] font-black tracking-tighter text-white leading-none">seven</span>
                <div className="flex flex-col items-start leading-none mb-0.5 ml-0.5">
                  <span className="text-[40px] font-light tracking-tighter text-white/95 leading-none">52</span>
                  <span className="text-[8px] tracking-[0.18em] text-white/50 uppercase leading-none font-bold mt-1">digital agency</span>
                </div>
              </div>
            </Link>
            ...
            <div className="flex items-center gap-3 mt-4">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/20 hover:border-white/50 flex items-center justify-center text-white/70 hover:text-white transition-all duration-300">
                <FontAwesomeIcon icon={faInstagram} className="w-4 h-4" />
              </a>
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/20 hover:border-white/50 flex items-center justify-center text-white/70 hover:text-white transition-all duration-300">
                <FontAwesomeIcon icon={faFacebookF} className="w-4 h-4" />
              </a>
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/20 hover:border-white/50 flex items-center justify-center text-white/70 hover:text-white transition-all duration-300">
                <FontAwesomeIcon icon={faLinkedinIn} className="w-4 h-4" />
              </a>
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/20 hover:border-white/50 flex items-center justify-center text-white/70 hover:text-white transition-all duration-300">

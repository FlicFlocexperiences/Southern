...
export const DesktopStats = () => {
  ...
  return (
    <section className="w-full relative z-30">
      ...
      <div className="w-full border-y border-black/5 bg-[#f2decc] shadow-[0_4px_30px_rgba(0,0,0,0.03)] backdrop-blur-md">
          ...
          <div className="flex flex-wrap lg:flex-nowrap items-center justify-between w-full gap-8 lg:gap-4 xl:gap-8">
            {stats.map((stat, idx) => (
              <div key={idx} className="flex flex-col items-start gap-1 min-w-[140px] xl:min-w-[180px]">
                <p className="text-[36px] lg:text-[42px] xl:text-[46px] font-semibold text-[#432d1c] leading-none">
                ...
                <p className="text-[16px] lg:text-[18px] xl:text-[22px] text-[#432d1c]/70 font-light whitespace-nowrap mt-2">
                  {stat.label}
                </p>
              </div>
            ))}

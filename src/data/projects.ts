...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: "Meta Ads",
    tag: "META ADS",
    categories: ["Meta Ads", "Social Media", "Lead Generation"],
    description: "An immersive digital showcase and creative paid advertising campaign designed for LOTD.",
    client: "LOTD Group",
    duration: "6 Weeks",
    services: "Meta Ads Strategy, Creative Direction, Paid Social Campaigns",
  ...
  },
  {
    ...
    category: "Web Design",
    tag: "WEB DESIGN",
    categories: ["Web Design", "Branding", "SEO"],
    description: "A high-performance technical identity and web showcase built for LYNX.",
    client: "LYNX Inc",
    duration: "8 Weeks",
    services: "Brand Strategy, 3D Rendering, Interactive Web, SEO",
  ...
  },
  {
    ...
    client: "Mr Pronto",
    duration: "4 Weeks",
    services: "Visual Identity, Packaging Design, UI/UX, Social Media",
  ...
  },
  {
    ...
    client: "Rise Inc.",
    duration: "6 Weeks",
    services: "Brand Strategy, Web Design, Visual Identity, SEO Strategy",
  ...
  },
  {
    ...
    duration: "10 Weeks",
    services: "Graphic Design, Creative Direction, Digital Art, Photography",

...
export const metadata: Metadata = {
  alternates: {
    canonical: '/services/app-development/chennai',
  },
  title: "App Development Company in Chennai",

  ...
  return (
    <div className="w-full bg-[#f2decc] min-h-screen pb-16">
      ...
      <ServiceLayout sections={tableOfContents}>
            ...
            <p className="text-[17px] md:text-[18px] leading-[1.75] text-[#432d1c]/90 my-5 font-normal font-sans tracking-[0.01em]">
              <strong className="font-semibold text-[#de5e18] tracking-tight">A powerful corporate website</strong> must be easily discoverable by procurement officers and decision-makers. Our web development in Chennai includes comprehensive technical SEO integrated directly into the initial architecture. We meticulously structure your site hierarchy, URL pathways, and metadata to ensure maximum visibility on search engines. <strong className="font-semibold text-[#de5e18] tracking-tight">Strategic content architecture</strong> is a massive focus for our team. We organize complex industrial information, spec sheets, and corporate capabilities into highly navigable structures, ensuring that both users and Google's crawlers can understand your offerings perfectly. This dedication to technical SEO ensures your business dominates local and national search results. For aggressive post-launch traffic scaling, explore our data-driven <Link href="/services/seo" className="text-[#de5e18] hover:underline font-semibold transition-colors duration-200">SEO solutions</Link>.
            </p>

  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full relative overflow-hidden bg-gradient-to-br from-[#1b1a15] to-[#2c1d10] py-10 lg:py-32 px-6 lg:px-[90px] rounded-[36px] mb-12 shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-[#ff5100]/10 flex flex-col items-start">
        ...
        <div className="max-w-[800px] relative z-10 flex flex-col items-start w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_280px] gap-8 xl:gap-12 items-start max-w-[1440px] mx-auto px-1">
        ...
        <div className="w-full min-w-0">
          ...
          <div className="flex items-center gap-2 mb-8 text-[13px] md:text-[14px] font-regular text-[#30261C]/55">
            ...
            <span>/</span>
            <Link href="/services" className="hover:text-[#ff5100] transition-colors">Services</Link>
            <span>/</span>
            <span className="text-[#30261C] font-regular truncate max-w-[200px] md:max-w-xs">{service.title}</span>
          </div>

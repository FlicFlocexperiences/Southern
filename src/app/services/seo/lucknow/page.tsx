  ...
  return (
    <div className="w-full bg-[#f2decc] min-h-screen pb-16">
      ...
      <ServiceLayout sections={tableOfContents}>
        <h3 id="lucknow-digital-landscape-seo" className="text-[22px] md:text-[28px] font-bold text-[#432d1c] mt-8 mb-4 font-sans scroll-mt-28">
          Digital Lead Acquisition and Search Visibility in the Capital
        </h3>
        <p className="text-[17px] md:text-[18px] leading-[1.75] text-[#432d1c]/90 my-5 font-normal font-sans tracking-[0.01em]">
          <strong className="font-semibold text-[#de5e18] tracking-tight">The commercial ecosystem of Lucknow</strong>, historically rooted in administrative administration and brick-and-mortar trading hubs, is experiencing a profound transition toward digital-first commerce. Local business enterprises are realizing that traditional customer acquisition channels are no longer sufficient to sustain long-term growth in a competitive state economy. To capture high-value market share, regional companies must establish robust organic visibility on major search engines to connect with modern consumers. We engineer bespoke search engine optimization strategies that align with this local economic transition and secure prominent search engine rankings. By building deep topical authority, we enable regional businesses to project a highly professional image and capture organic demand. Partnering with an elite <strong className="font-semibold text-[#de5e18]">SEO company in Lucknow</strong> converts your corporate website into a persistent source of qualified business leads. This structured approach helps capital brands build lasting market presence and decrease their dependence on offline marketing channels.
        </p>

        <h3 id="it-city-tech-seo" className="text-[22px] md:text-[28px] font-bold text-[#432d1c] mt-8 mb-4 font-sans scroll-mt-28">
        ...
        <h3 id="chikan-zardozi-export-seo" className="text-[22px] md:text-[28px] font-bold text-[#432d1c] mt-8 mb-4 font-sans scroll-mt-28">
          Globalizing Lucknow's Legacy Chikan and Zardozi Export Houses
        </h3>
        <p className="text-[17px] md:text-[18px] leading-[1.75] text-[#432d1c]/90 my-5 font-normal font-sans tracking-[0.01em]">
          <strong className="font-semibold text-[#de5e18] tracking-tight">Lucknow is home to world-renowned</strong> artisanal industries, particularly the production of exquisite Chikan embroidery and Zardozi textiles centered in the Chowk and old city areas. However, legacy B2B exporters and textile manufacturers are finding that traditional trade shows and agents are yielding declining returns. To reach international fashion brands and bulk wholesale buyers, these companies must adapt to modern digital procurement paths. We optimize B2B online catalogs, wholesale product sheets, and textile directories for competitive international search terms. Our search campaigns target global sourcing managers who actively search for authentic Indian manufacturers and exporters. We build high-authority backlink profiles from textile journals and international trade portals to establish global domain credibility. This organic search prominence enables legacy exporters to bypass traditional middlemen and secure larger direct contracts. By implementing structured metadata and detailed product specifications, we ensure that your unique artisanal craftsmanship ranks at the top of relevant international search results.
        </p>

        <h3 id="healthcare-pharmaceutical-seo" className="text-[22px] md:text-[28px] font-bold text-[#432d1c] mt-8 mb-4 font-sans scroll-mt-28">
          Medical and Agri-Tech SEO for Lucknow's Elite Scientific Clusters
        </h3>
        <p className="text-[17px] md:text-[18px] leading-[1.75] text-[#432d1c]/90 my-5 font-normal font-sans tracking-[0.01em]">
          <strong className="font-semibold text-[#de5e18] tracking-tight">As the host city for prestigious</strong> institutions such as the Central Drug Research Institute and SGPGIMS, Lucknow has developed a robust healthcare and medical technology ecosystem. Web platforms operating in these scientific domains require a distinct approach to search engine optimization that reflects high compliance, safety, and scientific credibility. We develop specialized search strategies that align with Google's strict requirements for quality and safety. Our optimization team refines scientific write-ups, medical blogs, and clinical service descriptions to demonstrate high topical accuracy. We construct comprehensive content hubs that address complex medical queries, positioning your organization as a trusted scientific authority. By building authoritative backlink profiles from medical journals and research databases like <a href="https://www.cdri.res.in/" target="_blank" rel="noopener noreferrer" className="text-[#de5e18] hover:underline font-semibold transition-colors duration-200">CDRI</a>, we secure stable search placements. This technical and scientific authority helps clinical research organizations, pharma brands, and medical laboratories reach partners and patients alike. Our tailored SEO solutions ensure that your scientific platform meets the highest standards of digital trust and visibility.
        </p>

        <h3 id="local-map-pack-hazratganj" className="text-[22px] md:text-[28px] font-bold text-[#432d1c] mt-8 mb-4 font-sans scroll-mt-28">
        ...
        <h3 id="roi-driven-analytics-conversion" className="text-[22px] md:text-[28px] font-bold text-[#432d1c] mt-8 mb-4 font-sans scroll-mt-28">
          Closed-Loop CRM Attribution and Organic Search ROI for Lucknow Brands
        </h3>
        <p className="text-[17px] md:text-[18px] leading-[1.75] text-[#432d1c]/90 my-5 font-normal font-sans tracking-[0.01em]">
          <strong className="font-semibold text-[#de5e18] tracking-tight">We prioritize genuine</strong> business growth over vanity metrics like impressions and basic search traffic figures. Our analytics frameworks connect search performance data with your CRM systems to track how organic traffic converts into business revenue. We monitor key performance metrics such as organic conversion speed, click-through rates, and lead quality. This data-backed approach allows us to continuously refine your campaigns and prioritize keywords with high transactional intent. We provide transparent monthly reports that detail these insights, helping you measure the true financial impact of your search marketing campaign. Our setups are built in compliance with local data protection regulations, ensuring user privacy and reducing security risks. By combining technical excellence with business intelligence, we help your brand achieve sustainable digital growth. We collaborate directly with your sales department to align our organic search strategy with your corporate revenue goals.
        </p>
          ...
          <div className="flex flex-col gap-8">
            <div className="border-b border-black/5 pb-6">
              <p className="text-[16px] text-black/80 leading-relaxed font-medium italic mb-4">
                "Operating our traditional Chikan embroidery export business out of Chowk required a shift in how we approach wholesale buyers. Traditional trade agents were yielding fewer leads, so we engaged Southern Edge Marketing to establish our digital authority. They built a custom search optimization campaign targeting global fashion buyers and boutique sourcing managers. Within seven months, our portal ranked on page one for major bulk textile export keywords, resulting in a 140% rise in international wholesale inquiries. Their understanding of the Lucknow trade ecosystem and B2B logistics made them a vital partner in our digital transition."
              </p>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 shrink-0 rounded-full overflow-hidden bg-gray-100 flex items-center justify-center">
                  <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=100&q=80" alt="Siddharth Tandon" className="w-full h-full object-cover object-center grayscale" />
                </div>
                <div>
            ...
            <div>
              <p className="text-[16px] text-black/80 leading-relaxed font-medium italic mb-4">
                "For our tech startup located in HCL IT City, ranking for enterprise software development keywords was critical to securing corporate clients in Europe and North America. Southern Edge Marketing optimized our Next.js architecture and built a highly specialized content cluster targeting enterprise CTO queries. Within six months, our organic traffic increased by 160%, driving high-quality B2B consultation requests directly to our sales pipeline. Their technical depth and understanding of Lucknow's growing IT ecosystem helped us achieve global search visibility."
              </p>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 shrink-0 rounded-full overflow-hidden bg-gray-100 flex items-center justify-center">
                  <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=100&q=80" alt="Neha Srivastava" className="w-full h-full object-cover object-center grayscale" />
                </div>
                <div>

...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Social Media Management Company in Sydney | Southern Edge Marketing",
    description: "Partner with Sydney's premier social media management company. We engineer high-converting B2B LinkedIn campaigns, executive thought leadership, and paid acquisition.",
    url: "https://southernedgemarketing.com/services/social-media-management/sydney",
    siteName: "Southern Edge Marketing",
    images: [
      {
        url: "https://southernedgemarketing.com/images/infographics/social-media-management-sydney.jpg",
        width: 1200,
        height: 675,
        alt: "Social Media Management in Sydney Infographic Blueprint",
      },
    ],
    locale: "en_AU",
    type: "website",
  ...
  twitter: {
    ...
    title: "Social Media Management Company in Sydney | Southern Edge Marketing",
    description: "Partner with Sydney's premier social media management company. We engineer high-converting B2B LinkedIn campaigns, executive thought leadership, and paid acquisition.",
    images: ["https://southernedgemarketing.com/images/infographics/social-media-management-sydney.jpg"],
  },
};
...
export default function SydneySocialMediaManagementPage() {
  const schemaData = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "ProfessionalService",
        "@id": "https://southernedgemarketing.com/services/social-media-management/sydney#organization",
        "name": "Southern Edge Marketing - Social Media Management Sydney",
        "url": "https://southernedgemarketing.com/services/social-media-management/sydney",
        "logo": "https://southernedgemarketing.com/logo.png",
        "image": "https://southernedgemarketing.com/images/infographics/social-media-management-sydney.jpg",
      ...
      {
        "@type": "Service",
        "@id": "https://southernedgemarketing.com/services/social-media-management/sydney#service",
        "name": "Social Media Management in Sydney",
        "provider": {
          "@type": "ProfessionalService",
        ...
        "description": "Enterprise social media management, B2B LinkedIn executive thought leadership, algorithmic short-form video production, Privacy Act 1988 compliant paid ad acquisition, and multi-touch attribution for Sydney corporate leaders and New South Wales enterprises."
      },
      {
        "@type": "WebPage",
        "@id": "https://southernedgemarketing.com/services/social-media-management/sydney#webpage",
        "url": "https://southernedgemarketing.com/services/social-media-management/sydney",
        "name": "Social Media Management Company in Sydney | Southern Edge Marketing",
        "description": "Enterprise social media management, executive thought leadership, algorithmic short-form video, and Privacy Act compliant ad acquisition for Sydney enterprises.",
        "isPartOf": {
          "@type": "WebSite",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://southernedgemarketing.com/services/social-media-management/sydney#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Social Media Management in Sydney",
            "item": "https://southernedgemarketing.com/services/social-media-management/sydney"
          }
        ]
      },
      {
        "@type": "FAQPage",
        "@id": "https://southernedgemarketing.com/services/social-media-management/sydney#faq",
        "mainEntity": [
          {
            "@type": "Question",
          ...
          {
            "@type": "Question",
            "name": "How do your social media strategies drive B2B enterprise client acquisition in Sydney?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "We combine executive ghostwriting and thought leadership on LinkedIn with precision Account-Based Marketing paid funnels, delivering technical whitepapers and proprietary data analyses directly to verified C-suite decision-makers across Barangaroo and Martin Place."
            }
          },
          {
            "@type": "Question",
          ...
          {
            "@type": "Question",
            "name": "What short-form video production capabilities do you provide for Sydney enterprises?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Our production studio delivers end-to-end 4K vertical video production, including commercial scripting, on-location cinematography across Sydney, kinetic typography, professional color grading, and comprehensive management of vetted Australian creator partnerships."
            }
          },
          {
            "@type": "Question",
          ...
          {
            "@type": "Question",
            "name": "How does NSW-IX peering improve social campaign landing page conversion rates?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "By caching digital campaign assets at Equinix Alexandria carrier facilities and peering at NSW-IX, landing pages load within single-digit milliseconds, eliminating mobile bounce rates and maximizing paid traffic conversion efficiency."
            }
          },
          {
            "@type": "Question",
  ...
  return (
    <div className="w-full bg-[#f2decc] min-h-screen pb-16">
      ...
      <ServiceHero 
        title={"Enterprise Social Media Management Company in Sydney"}
        tagline={"Accelerating enterprise growth, executive thought leadership, and algorithmic social acquisition for Sydney corporate leaders, Barangaroo financial institutions, and high-growth technology scale-ups."}
        breadcrumbTitle={"Social Media Management in Sydney"}
      />
      ...
      <ServiceLayout sections={tableOfContents}>
        ...
        <p className="text-[17px] md:text-[18px] leading-[1.75] text-[#432d1c]/90 my-5 font-normal font-sans tracking-[0.01em]">
          Our dedicated social media practice treats modern channels as programmatic engagement networks. We combine quantitative audience telemetry with bespoke creative assets to establish unmistakable market leadership, accelerate enterprise sales pipelines, and defend brand reputation across Australia. Whether expanding an enterprise technology scale-up in North Sydney or stewarding private wealth portfolios along Macquarie Street, our senior digital strategists provide the creative distinction and commercial rigor required to secure profitable market share. To learn more about our engineering-driven methodology, explore our background on our <Link href="/about" className="text-[#de5e18] hover:underline font-semibold transition-colors duration-200">about us</Link> page.
        </p>
        ...
        <div className="bg-white border border-black/10 rounded-2xl overflow-hidden shadow-sm my-10 text-[#432d1c]">
          ...
          <div className="bg-[#f2decc]/60 border-t border-black/10 py-3 px-5 flex flex-wrap items-center justify-between gap-3 text-xs text-[#432d1c]">
            <div className="flex items-center gap-2">
              ...
              <span><strong>Strategic Crux:</strong> Enterprise social distribution uniting Barangaroo executive thought leadership, first-party server-side CAPI telemetry, rigorous ACCC creator governance, and NSW-IX edge caching.</span>
            </div>
        ...
        <p className="text-[17px] md:text-[18px] leading-[1.75] text-[#432d1c]/90 my-5 font-normal font-sans tracking-[0.01em]">
          Our enterprise partnerships operate under structured agile sprints backed by comprehensive service level agreements. Our dedicated team of digital strategists, commercial copywriters, and paid media specialists operates directly in Australian Eastern Time (AEST/AEDT), ensuring immediate communication, real-time brand protection, and proactive campaign adjustments. We conduct monthly executive briefings to synchronize marketing initiatives with your corporate commercial objectives. When your organization is ready to establish unmatched social media authority, <Link href="/contact" className="text-[#de5e18] hover:underline font-semibold transition-colors duration-200">contact our social media team</Link> to schedule a confidential strategy session.
        </p>
          ...
          <div className="flex flex-col gap-8">
            <div className="border-b border-black/5 pb-6">
              <p className="text-[16px] text-black/80 leading-relaxed font-medium italic mb-4">
                &quot;Southern Edge Marketing completely transformed our B2B social acquisition pipeline across Barangaroo. Their executive thought leadership campaigns on LinkedIn and server-side Conversions API integration generated a 46% increase in qualified institutional demo bookings within six months, while reducing customer acquisition costs by 28% and ensuring continuous compliance.&quot;
              </p>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[12px] text-black/50 uppercase tracking-wide">Partner, Apex Capital Partners (Barangaroo, Sydney)</p>
                </div>
              </div>
            </div>
            <div>
              <p className="text-[16px] text-black/80 leading-relaxed font-medium italic mb-4">
                &quot;Managing social marketing for our enterprise software platform in Surry Hills required authentic technical storytelling and rigorous compliance with Australian privacy standards. Southern Edge Marketing delivered exceptional 4K short-form video assets and developer-focused ad campaigns that doubled our active user acquisition rate across New South Wales.&quot;
              </p>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 shrink-0 rounded-full overflow-hidden bg-gray-100 flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-[12px] text-black/50 uppercase tracking-wide">Chief Marketing Officer, CloudMesh Systems (Surry Hills, Sydney)</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <FaqAccordion faqs={[
          ...
          {
            "question": "How do your social media strategies drive B2B enterprise client acquisition in Sydney?",
            "answer": "We combine executive ghostwriting and thought leadership on LinkedIn with precision Account-Based Marketing paid funnels, delivering technical whitepapers and proprietary data analyses directly to verified C-suite decision-makers across Barangaroo and Martin Place."
          },
          {
          ...
          {
            "question": "What short-form video production capabilities do you provide for Sydney enterprises?",
            "answer": "Our production studio delivers end-to-end 4K vertical video production, including commercial scripting, on-location cinematography across Sydney, kinetic typography, professional color grading, and comprehensive management of vetted Australian creator partnerships."
          },
          {
          ...
          {
            "question": "How does NSW-IX peering improve social campaign landing page conversion rates?",
            "answer": "By caching digital campaign assets at Equinix Alexandria carrier facilities and peering at NSW-IX, landing pages load within single-digit milliseconds, eliminating mobile bounce rates and maximizing paid traffic conversion efficiency."
          },
          {
